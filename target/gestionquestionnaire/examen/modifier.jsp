...
<head>
    <meta charset="UTF-8">
    <title>Gestion Questionnaire - Modifier Examen</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <form action="examen" method="post">
            ...
            <input type="hidden" name="id" value="${examen.numExam}"/>

            <label for="numEtudiant">Numéro Étudiant:</label>
            <input type="text" id="numEtudiant" name="numEtudiant" value="${examen.numEtudiant}" required/><br/>

            <label for="anneeUniv">Année Universitaire:</label>
            <input type="text" id="anneeUniv" name="anneeUniv" value="${examen.anneeUniv}" required/><br/>

            <label for="note">Note:</label>
            <input type="number" id="note" name="note" min="0" max="10" value="${examen.note}" required/><br/>

            <div style="margin-top: 30px;">
                <button type="submit" id="submitBtn"><i class="fas fa-save"></i> Modifier l'examen</button>
